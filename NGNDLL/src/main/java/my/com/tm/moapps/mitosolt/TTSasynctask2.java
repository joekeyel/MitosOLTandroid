...
public class TTSasynctask2 extends AsyncTask<String,Void,String> {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
          ...
          conn = (HttpURLConnection) url.openConnection();
            ...
            body.put("displayNbr",callee);
            body.put("calleeNbr",callee);
            body.put("languageType", 0);
            body.put("ttsContent", "This is Remote System Calling from MCC");
            body.put( "replayTimes",1);
