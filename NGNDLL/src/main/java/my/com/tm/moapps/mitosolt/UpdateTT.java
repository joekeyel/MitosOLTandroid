 ...
 */
public class UpdateTT extends AsyncTask<String,Void,String> {

   Context context;

    public UpdateTT(Context applicationContext) {
    ...
    protected String doInBackground(String... params) {
            ...
            try {
                ...
                String data = URLEncoder.encode("No", "UTF-8") + "=" + URLEncoder.encode(No, "UTF-8") +
                        "&" + URLEncoder.encode("select", "UTF-8") + "=" + URLEncoder.encode(Status, "UTF-8") +
