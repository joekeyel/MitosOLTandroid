 ...
 */
public class audittrail2 extends AsyncTask<String, Integer, ArrayList<auditmodel>> {

    String ttno2;

    public audittrail2(Context applicationContext) {
    ...
    protected void onPostExecute(ArrayList<auditmodel> strings) {
            ...
            LoadTTall.getInstance().onShowPopup2(strings);
            LoadTTall.getInstance().progressbarhide();
